...
describe('most blogs', () => {
  ...
  test('of list with one blog, author has the most blogs', () => {
  ...
  test('of a bigger list, author with more blogs', () => {
...
describe('most likes', () => {
  ...
  test('of list with one blog, author is most liked', () => {
  ...
  test('of a bigger list, author with most likes', () => {
